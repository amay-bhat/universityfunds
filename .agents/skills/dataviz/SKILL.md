---
name: dataviz
description: Chart design discipline for this project — palette roles, slot assignments, honesty rules for gaps and mixed bases, chart chrome contract, and the render-and-look verification pass. Read before writing or changing any chart code (AGENTS.md rule 5, CONSTITUTION Article 6).
---

# dataviz — chart discipline

`AGENTS.md` rule 5 and `CONSTITUTION.md` Article 6 make reading this a
...
> `.agents/skills/`, not in `~/.agents/skills/`), and neither is
